...
def main() -> None:
    ...
    for optional in ("huber", "lnr"):
        if optional in steps.columns:
            step_metrics[optional] = numeric(steps, optional)
    ...
    result = {
        ...
        "implementation_revision": "exact_step_reconstruction.v2",
    ...
    print("IMPLEMENTATION_REVISION=exact_step_reconstruction.v2")
