...
require(len(bootstrap) == 1 and int(bootstrap[0]) == 0, "bootstrap acceptance must occur exactly at step zero")
require(reliable[0] and accepted[0], "bootstrap estimate was not reliable and accepted")
require(same_float(previous_norm[0], 0.0), "bootstrap previous norm was not zero")
...
bootstrap_ratio = float(candidate_norm[0] / truth_norm[0])
...
summary = {
    ...
    "bootstrap_candidate_norm": float(candidate_norm[0]),
    "bootstrap_truth_norm": float(truth_norm[0]),
