...
EXTERNAL_TOTAL = 45
HOLD_FACTOR = 50.0
MODEL_INCREMENT_COMPONENT = 0.02
MODEL_INCREMENT_SCALE = math.sqrt(N) * MODEL_INCREMENT_COMPONENT
EXPECTED_JUMP_LIMIT = HOLD_FACTOR * MODEL_INCREMENT_SCALE
...
summary = {
    ...
    "bootstrap_step_index": int(step["step_index"].iloc[bootstrap_index]),
